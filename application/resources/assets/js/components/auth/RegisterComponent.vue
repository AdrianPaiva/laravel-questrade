		...
		<el-col :span="20" :offset="2">
			...
			<el-form :model="registerForm" :rules="rules" ref="registerForm" >
				...
				<el-form-item label="Email" prop="email" required>
					<el-input v-model="registerForm.email" type="email" :disabled="true"></el-input>
				</el-form-item>
		...
		methods: {
			onRegister(registerForm) {
				...
				this.$refs[registerForm].validate((valid) => {
					if (valid) {
						axios.patch('/register', {first_name: this.registerForm.firstname, last_name: this.registerForm.lastname, email: this.registerForm.email, password: this.registerForm.password, password_confirmation: this.registerForm.confirmpassword })
						.then(response => {
